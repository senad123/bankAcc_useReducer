...
1. Let's implement a simple bank account! 
  It's similar to the example that I used as an analogy to explain how useReducer works, 
...
function reducer(state, action) {
  //prevent to add deposit if Account is not open
  ...
  switch (action.type) {
    ...
    case "payLoan":
      if (!state.loan || state.loan < action.payload) return state;
